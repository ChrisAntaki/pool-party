...
module.exports = class YouGetWhatYouGive {
    ...
    getListOfGivingOrganizations() {
        return _.clone(this.organizations);
    }
    ...
    getSortedListOfOwedOrganizations() {
        return _.filter(this.organizations, (organization) => {
            ...
            // Sort those who are owed more first
            let ratioA = a.received.length / a.sourced.length;
            let ratioB = b.received.length / b.sourced.length;
